...
from ragas.metrics.base import EvaluationMode, Metric, MetricWithLLM
...
class QGen:
    def __init__(self, model_name: str, device: str) -> None:
        ...
        self.max_len = 512
        self.question_template = "Generate question for the given answer\n"
...
@dataclass
class GPTAnswerRelevancy(MetricWithLLM):
    """
