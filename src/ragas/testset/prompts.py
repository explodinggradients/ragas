...
CONVERSATION_QUESTION = Prompt(
    ...
    examples=[{
        ...
        "output":{"first_question":"What are the benefits of remote work?",
...
FILTER_QUESTION = Prompt(
    ...
    examples=[{
        ...
        "output":{"reason":"The question is too vague and does not specify which discovery about space it is referring to.","verdit":"No"}
    },{
        "question":"What caused the Great Depression?",
        "output":{"reason":"The question is specific and refers to a well-known historical economic event, making it clear and answerable.","verdict":"Yes"}
    },{
        "question":"What is the keyword that best describes the paper's focus in natural language understanding tasks?",
        "output":{"reason":"The question mentions a 'paper' in it without referring it's name which makes it unclear without it","verdict":"No"}
    },{
        "question":"Who wrote 'Romeo and Juliet'?",
        "output":{"reason":"The question is clear and refers to a specific work by name therefore it is clear","verdict":"Yes"}
    },{
        "question":"What did the study mention?",
        "output":{"reason":"The question is vague and does not specify which study it is referring to","verdict":"No"}
    },{
        "question":"What is the focus of the REPLUG paper?",
        "output":{"reason":"The question refers to a specific work by it's name hence can be understood","verdict":"Yes"}
    },{
        "question":"What is the purpose of the reward-driven stage in the training process?",
        "output":{"reason":"The question lacks specific context regarding the type of training process, making it potentially ambiguous and open to multiple interpretations.","verdict":"No"}
    }], 
    input_keys=["question"],
    output_key="output",
    output_type="json",
...
EVOLUTION_ELIMINATION = Prompt(
    ...
    examples=[{
        ...
        "output":{"reason":"While both questions deal with environmental issues, 'climate change' encompasses broader changes than 'global warming', leading to different depths of inquiry.","verdict":"Not Equal"}
    },{
        "question1":"How does photosynthesis work in plants?",
        "question2":"Can you explain the process of photosynthesis in plants?",
        "output":{"reason":"Both questions ask for an explanation of the photosynthesis process in plants, sharing the same depth, breadth, and requirements for the answer.","verdict":"Equal"}
    }],
...
ANSWER_FORMULATE = Prompt(
    name="answer_formulate",
    instruction="""Answer the question using the information from the given context."""
    examples=[{
        "question":"",
        "context":""
        "answer":""
