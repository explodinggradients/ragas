...
from ragas.experimental.backends.local_jsonl import LocalJSONLBackend
...
if __name__ == "__main__":
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        try:
            ...
            # Test nested data
            nested_data = [{"id": 1, "metadata": {"score": 0.85, "tags": ["test"]}}]
            ...
            print(
                f"Types: {type(nested_data[0]['metadata'])} -> {type(loaded[0]['metadata'])}"
            )
