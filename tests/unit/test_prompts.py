...
faithfulness = Faithfulness(long_answer_prompt=test_prompt, nli_stmt_prompt=test_prompt)


def test_prompts():

    assert answer_relevancy.question_gen_prompt==test_prompt, "Answer relevancy custom prompt error"
    ...
    assert faithfulness.nli_stmt_prompt==test_prompt, "Faithfulness custom prompt error"