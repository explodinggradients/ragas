...
class TestNotionBackend:
    ...
    def test_notion_availability(self):
        """Test that NOTION_AVAILABLE is set correctly."""
        # This will be True during testing due to our mocking
        assert isinstance(NOTION_AVAILABLE, bool)

    @patch.dict(os.environ, {"NOTION_TOKEN": "test_token", "NOTION_DATABASE_ID": "test_db_id"})
    def test_init_with_env_vars(self, mock_notion_client, mock_database_response):
    ...
    def test_init_with_explicit_params(self, mock_database_response):
    ...
    def test_init_missing_database_id(self):
    ...
    def test_convert_to_notion_properties(self, mock_database_response):
    ...
    def test_convert_from_notion_properties(self, mock_database_response):
    ...
    def test_query_database(self, mock_database_response, mock_query_response):
    ...
    def test_save_dataset(self, mock_database_response, sample_data):
    ...
    def test_load_dataset(self, mock_database_response, mock_query_response):
    ...
    def test_load_nonexistent_dataset(self, mock_database_response):
    ...
    def test_list_datasets(self, mock_database_response):
    ...
    def test_experiment_operations(self, mock_database_response, sample_data):
    ...
    def test_repr(self, mock_database_response):
    ...
    def test_data_truncation(self, mock_database_response):
