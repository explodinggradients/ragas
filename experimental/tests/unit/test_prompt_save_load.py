...
class TestPromptSaveLoad:
    ...
    def test_save_with_response_model_shows_warning(self, tmp_path):
        ...
        assert data["response_model_info"]["note"] == "You must provide this model when loading"
    ...
    def test_unicode_characters_handling(self, tmp_path):
        ...
        formatted = loaded.format(question="Comment allez-vous? 😊", language="français")
        # Should contain the formatted instruction
        expected_instruction = "Répondez à la question en français: Comment allez-vous? 😊 🤔"
