...
class TestDynamicFewShotPromptSaveLoad:
    ...
    def test_save_load_with_embedding_model(self, tmp_path):
        ...
        loaded = DynamicFewShotPrompt.load(str(json_path), embedding_model=new_embedding)
    ...
    def test_embedding_recomputation_on_load(self, tmp_path):
        ...
        assert len(loaded.example_store._embeddings_list) >= 0  # May be computed during init
    ...
    def test_json_structure_validation(self, tmp_path):
        ...
        required_fields = [
            "format_version", "type", "instruction", "examples",
            "response_model_info", "max_similar_examples", 
    ...
    def test_warning_messages(self, tmp_path):
        ...
        with pytest.warns(UserWarning, match="embedding_model.*similarity-based.*will not work"):
    ...
    def test_error_conditions(self, tmp_path):
        ...
        with open(wrong_type_path, 'w') as f:
            json.dump({"type": "Prompt", "instruction": "test"}, f)  # Regular Prompt, not DynamicFewShotPrompt
    ...
    def test_round_trip_data_preservation(self, tmp_path):
        ...
        examples = [
            ...
            ({"param1": "test", "param2": "data"}, {"result": "output2", "extra": "info"})
        ]
