...
class Project:
    ...
    def get_dataset(
        ...
        """
        dataset_id, dataset_backend = self._backend.get_dataset_by_name(dataset_name, model)
    ...
    def get_dataset_path(self, dataset_name: str) -> str:
        ...
        return os.path.join(self._backend._project_dir, "datasets", f"{dataset_name}.csv")
    ...
    def get_experiment_path(self, experiment_name: str) -> str:
        ...
        if not isinstance(self._backend, LocalCSVProjectBackend):
            raise ValueError("This method is only available for local_csv backend")
        return os.path.join(self._backend._project_dir, "experiments", f"{experiment_name}.csv")
